...
public class E2E_POJO_DataProvider extends base.BaseTest{
	
	@Test(dataProvider = "getEDataPOJO", dataProviderClass = E2EData.class)
	public void endToend(UserData user) throws InterruptedException, IOException {
	    // Home Page check
